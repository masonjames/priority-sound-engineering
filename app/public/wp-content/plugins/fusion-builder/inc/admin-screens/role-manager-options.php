	...
	<div class="fusion-builder-option">
		<div class="fusion-builder-option-title">
			...
			<span class="fusion-builder-option-label">
				<p>
					<?php esc_html_e( 'Manage access to various Avada components based on user roles. If you reset a role, the default access levels will be used for users of that role.', 'fusion-builder' ); ?>
				</p>
			</span>
		</div>
											...
											<li class="awb-role-manager-access-item awb-dashboard-access">
												<div class="fusion-builder-option-field">
													...
													<div class="fusion-form-radio-button-set ui-buttonset enable-builder-ui">
														...
														<input type="checkbox" <?php echo $value ? 'checked' : ''; ?> class="awb-hidden button-set-value awb-role-manager-dashboard-access" name="role_manager_caps[<?php echo esc_attr( $role_name ); ?>][<?php echo esc_attr( $post_type->name ); ?>][dashboard_access]" value="<?php echo esc_attr( $value ); ?>" />
											...
											<li class="awb-role-manager-access-item">
												<div class="fusion-builder-option-field">
													...
													<div class="fusion-form-radio-button-set ui-buttonset enable-builder-ui<?php echo esc_attr( $maybe_disabled ); ?>">
														...
														<input type="checkbox" <?php echo $value ? 'checked' : ''; ?> class="awb-hidden button-set-value" name="role_manager_caps[<?php echo esc_attr( $role_name ); ?>][<?php echo esc_attr( $post_type->name ); ?>][backed_builder_edit]" value="<?php echo esc_attr( $value ); ?>" />
														<a data-value="on" class="ui-button buttonset-item<?php echo ( 'on' === $value ) ? ' ui-state-active' : ''; ?>" href="#"><?php esc_html_e( 'On', 'fusion-builder' ); ?></a>
														<a data-value="off" class="ui-button buttonset-item<?php echo ( 'off' === $value ) ? ' ui-state-active' : ''; ?>" href="#"><?php esc_html_e( 'Off', 'fusion-builder' ); ?></a>
													</div>
												</div>
											...
											<li class="awb-role-manager-access-item">
												<div class="fusion-builder-option-field">
													...
													<div class="fusion-form-radio-button-set ui-buttonset enable-builder-ui<?php echo esc_attr( $maybe_disabled ); ?>">
														...
														<input type="checkbox" <?php echo $value ? 'checked' : ''; ?> class="awb-hidden button-set-value" name="role_manager_caps[<?php echo esc_attr( $role_name ); ?>][<?php echo esc_attr( $post_type->name ); ?>][live_builder_edit]" value="<?php echo esc_attr( $value ); ?>" />
														<a data-value="on" class="ui-button buttonset-item<?php echo ( 'on' === $value ) ? ' ui-state-active' : ''; ?>" href="#"><?php esc_html_e( 'On', 'fusion-builder' ); ?></a>
														<a data-value="off" class="ui-button buttonset-item<?php echo ( 'off' === $value ) ? ' ui-state-active' : ''; ?>" href="#"><?php esc_html_e( 'Off', 'fusion-builder' ); ?></a>
													</div>
												</div>
										...
										<li class="awb-role-manager-access-item">
											<div class="fusion-builder-option-field">
												...
												<div class="fusion-form-radio-button-set ui-buttonset enable-builder-ui<?php echo esc_attr( $maybe_disabled ); ?>">
													...
													<input type="checkbox" <?php echo $value ? 'checked' : ''; ?> class="awb-hidden button-set-value" name="role_manager_caps[<?php echo esc_attr( $role_name ); ?>][<?php echo esc_attr( $post_type->name ); ?>][page_options]" value="<?php echo esc_attr( $value ); ?>" />
													<a data-value="on" class="ui-button buttonset-item<?php echo ( 'on' === $value ) ? ' ui-state-active' : ''; ?>" href="#"><?php esc_html_e( 'On', 'fusion-builder' ); ?></a>
													<a data-value="off" class="ui-button buttonset-item<?php echo ( 'off' === $value ) ? ' ui-state-active' : ''; ?>" href="#"><?php esc_html_e( 'Off', 'fusion-builder' ); ?></a>
												</div>
											</div>
											...
											<li class="awb-role-manager-access-item awb-form-submissions">
												<div class="fusion-builder-option-field">
													...
													<div class="fusion-form-radio-button-set ui-buttonset enable-builder-ui">
														...
														<input type="checkbox" <?php echo $value ? 'checked' : ''; ?> class="awb-hidden button-set-value" name="role_manager_caps[<?php echo esc_attr( $role_name ); ?>][<?php echo esc_attr( $post_type->name ); ?>][submissions_access]" value="<?php echo esc_attr( $value ); ?>" />
														<a data-value="on" class="ui-button buttonset-item<?php echo ( 'on' === $value ) ? ' ui-state-active' : ''; ?>" href="#"><?php esc_html_e( 'On', 'fusion-builder' ); ?></a>
														<a data-value="off" class="ui-button buttonset-item<?php echo ( 'off' === $value ) ? ' ui-state-active' : ''; ?>" href="#"><?php esc_html_e( 'Off', 'fusion-builder' ); ?></a>
													</div>
												</div>
											...
											<li class="awb-role-manager-access-item">
												<div class="fusion-builder-option-field">
													...
													<div class="fusion-form-radio-button-set ui-buttonset enable-builder-ui<?php echo esc_attr( $maybe_disabled ); ?>">
														...
														<input type="checkbox" <?php echo $value ? 'checked' : ''; ?> class="awb-hidden button-set-value" name="role_manager_caps[<?php echo esc_attr( $role_name ); ?>][<?php echo esc_attr( $post_type->name ); ?>][global_elements]" value="<?php echo esc_attr( $value ); ?>" />
														<a data-value="on" class="ui-button buttonset-item<?php echo ( 'on' === $value ) ? ' ui-state-active' : ''; ?>" href="#"><?php esc_html_e( 'On', 'fusion-builder' ); ?></a>
														<a data-value="off" class="ui-button buttonset-item<?php echo ( 'off' === $value ) ? ' ui-state-active' : ''; ?>" href="#"><?php esc_html_e( 'Off', 'fusion-builder' ); ?></a>
													</div>
												</div>
