...
?>
<div id="rtec-modal-item-<?php echo esc_attr( $feature['slug'] ); ?>" class="rtec-modal-item">

<div class="rtec-modal-columns-wrap">
    <div class="rtec-modal-column rtec-dk-green-bg">
        <div class="rtec-modal-column-inner">

            <div class="rtec-pro-feature-image-wrap">
                <img src="<?php echo esc_url( $feature['img'] ); ?>" alt="pro feature example">
            </div>
        </div>
    </div>
    <div class="rtec-modal-column rtec-lt-green-bg">
        <div class="rtec-modal-column-inner">
            <div class="rtec-modal-header">
		        <?php echo esc_html( $feature['heading'] ); ?>
            </div>
            <div class="rtec-modal-copy">
	            <?php echo esc_html( $feature['description'] ); ?>
            </div>
            <a class="rtec-offer-cta rtec-heavy-shadow" href="https://roundupwp.com/products/registrations-for-the-events-calendar-pro/?utm_campaign=rtec-free&utm_source=pro-features-modal&utm_medium=<?php echo esc_attr( $feature['slug'] ); ?>-discount&utm_content=Get50%Off">
            ...
            <div class="rtec-other-pro">
                <div class="rtec-other-pro-inner">
                <div class="rtec-other-pro-heading">
	                <?php esc_html_e( 'Plus additional features that include:', 'registrations-for-the-events-calendar') ?>
                </div>
            ...
            <div class="rtec-buynow-wrap">
                <a href="https://roundupwp.com/products/registrations-for-the-events-calendar-pro/?utm_campaign=rtec-free&utm_source=pro-features-modal&utm_medium=<?php echo esc_attr( $feature['slug'] ); ?>-cta&utm_content=BuyNow" class="rtec-pro-feature-cta">
