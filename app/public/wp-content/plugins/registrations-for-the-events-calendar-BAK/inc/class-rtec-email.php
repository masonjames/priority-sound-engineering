	...
	protected function find_and_replace( $text, $sanitized_data ) {
		...
		if ( ! empty( $sanitized_data ) ) {
			...
			if ( strpos( $working_text, '{unregister-button}' ) !== false ) {
				$working_text = str_replace( '{unregister-button}', rtec_generate_unregister_button( $sanitized_data['event_id'], $sanitized_data['action_key'], $sanitized_data['email'], $require_confirmation ), $working_text );
			}
		}
